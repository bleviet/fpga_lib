...
from fpga_lib.model.validators import validate_ip_core
...
def test_memory_map():
    ...
    ctrl_reg = Register(
        ...
        fields=[
            ...
            BitField(name="RESERVED", bit_offset=2, bit_width=30, access=AccessType.READ_ONLY),
        ],
    )
    ...
    status_reg = Register(
        ...
        fields=[
            ...
            BitField(name="RESERVED", bit_offset=1, bit_width=31, access=AccessType.READ_ONLY),
        ],
    )
