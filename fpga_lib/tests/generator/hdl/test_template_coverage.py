...
from fpga_lib.model.base import VLNV, Parameter, ParameterType
from fpga_lib.model.port import Port, PortDirection
from fpga_lib.model.memory import MemoryMap, AddressBlock, Register, BitField, AccessType
from fpga_lib.model.port import Port, PortDirection
...
class TestTemplateRendering:
    ...
    def test_cocotb_test_with_registers(self, generator, ip_core_with_registers):
        ...
        assert "reg_test_memmap.yml" in result
    ...
    def test_testbench_files_all_render(self, generator, ip_core_with_registers):
        ...
        # Should have test, makefile, memmap
