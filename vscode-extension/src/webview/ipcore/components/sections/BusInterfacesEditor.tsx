                                        ...
                                        <div className="px-4 py-2 flex items-center gap-3 text-sm" style={{ background: 'var(--vscode-editor-background)' }}>
                                            ...
                                            {editingPrefix === index ? (
                                                <div className="flex items-center gap-2 flex-1">
                                                    ...
                                                    <button onClick={cancelEditPrefix} className="px-2 py-1 rounded text-sm" style={{ background: 'var(--vscode-button-secondaryBackground)', color: 'var(--vscode-button-foreground)' }}>Cancel</button>
                                                </div>
                                            ) : (
                                                <div className="flex items-center gap-2 flex-1">
