...
const RegisterMapVisualizer: React.FC<RegisterMapVisualizerProps> = ({
    ...
    const visualGroups = useMemo(() => {
        ...
        if (totalSize === 0) return groups.map(g => ({ ...g, widthPercent: 100 / groups.length }));
                            ...
                            >
                                ...
                                >
                                    <div className="font-bold">
                                        {group.name}
                                        <span className="ml-2 vscode-muted font-mono text-[11px]">[+{toHex(group.offset)}]</span>
                                    </div>
                                ...
                                <div className="flex w-full justify-center">
                                    <div className="text-center text-[11px] vscode-muted font-mono mt-1">+{toHex(group.offset)}</div>
                                </div>
                            </div>
                        );
                    })}
