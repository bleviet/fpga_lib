 ...
 */
export function validateUniqueName(name: string, existingNames: string[], currentName?: string): string | null {
    if (name === currentName) return null; // Editing current item
