...
from ipcore_lib.runtime.register import AbstractBusInterface, BitField, Register
...
class TestRW1CAccessType:
    ...
    def test_rw1c_single_bit_clear(self):
        ...
        self.bus.write_word(
            0x10, 0x00010F03
        )  # control=1, error_flags=15, rx_complete=1, tx_complete=1
    ...
    def test_rw1c_read_all_fields(self):
        ...
        self.bus.write_word(
            0x10, 0x00AA0F03
        )  # control=170, error_flags=15, rx_complete=1, tx_complete=1
