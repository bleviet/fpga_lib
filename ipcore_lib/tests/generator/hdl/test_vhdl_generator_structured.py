...
from ipcore_lib.model.core import VLNV, IpCore
from ipcore_lib.model.memory import AddressBlock, BitField, MemoryMap, Register
...
class TestVHDLGeneratorStructured:
    ...
    def test_structured_with_regfile(self, simple_ip_core):
        ...
        generator = VHDLGenerator()
        files = generator.generate_all(
            simple_ip_core, bus_type="axil", structured=True, include_regfile=True
        )
