...
PYTHONPATH=/home/balevision/workspace/bleviet/ipcore_lib uv run pytest ipcore_lib/tests/generator/hdl/ -v
```

### Run only unit tests:
```bash
PYTHONPATH=/home/balevision/workspace/bleviet/ipcore_lib uv run pytest ipcore_lib/tests/generator/hdl/test_vhdl_generator.py -v
```

### Run only end-to-end tests:
```bash
PYTHONPATH=/home/balevision/workspace/bleviet/ipcore_lib uv run pytest ipcore_lib/tests/generator/hdl/test_vhdl_generator_e2e.py -v
```

### Run only template coverage tests:
```bash
PYTHONPATH=/home/balevision/workspace/bleviet/ipcore_lib uv run pytest ipcore_lib/tests/generator/hdl/test_template_coverage.py -v
```

### Run syntax validation tests (requires GHDL):
```bash
PYTHONPATH=/home/balevision/workspace/bleviet/ipcore_lib uv run pytest ipcore_lib/tests/generator/hdl/test_vhdl_generator_e2e.py::TestVHDLGeneratorSyntaxValidation -v
```

### Skip slow tests:
```bash
PYTHONPATH=/home/balevision/workspace/bleviet/ipcore_lib uv run pytest ipcore_lib/tests/generator/hdl/ -v -m "not slow"
```
