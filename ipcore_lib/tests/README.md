...
### Core Tests (`ipcore_lib/tests/core/`)
...
cd /path/to/ipcore_lib
uv run python ipcore_lib/tests/core/test_register_rw1c.py
...
```bash
# Run all core tests
uv run pytest ipcore_lib/tests/core/ -v

# Run specific test file
uv run pytest ipcore_lib/tests/core/test_register_rw1c.py -v
```
...
1. Place core functionality tests in `ipcore_lib/tests/core/`
