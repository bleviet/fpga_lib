...
### Data Models
We use **Pydantic** for all data structures (`ipcore_lib.model.*`). This ensures that the unstructured JSON returned by the LLM is strictly validated before being used.
